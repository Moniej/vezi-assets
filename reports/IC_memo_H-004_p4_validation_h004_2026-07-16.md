# Investment Committee Memo — H-004
...
- cost_drag_eliminates_excess [signal_quality]: gross excess +17.02%, net excess +6.63%
- single_sector_dependency [signal_quality]: NGXASI contributes 65% of positive return (limit 100%)
- oos_performance_collapses [signal_quality]: OOS Sharpe 2.74 vs IS 1.09 (retention floor 25%)

## Contradictory evidence

- placebo_performs_similarly [signal_quality]: placebo p=0.079 (alpha=0.05): real strategy NOT distinguishable from shuffled sector labels
- single_regime_dependency [signal_quality]: regime 'pre2023' contributes 100% of positive excess (limit 80%); per-regime excess: pre2023=+2.1%, shock_2023_24=-11.8%, bull_2025_26=-11.9%
- placebo: real strategy indistinguishable from shuffled labels (p=0.0792)
- NO parameter cell survives Holm correction across 8 tests (raw significant: 0)

## Parameter robustness

50% of 8
parameter cells (lookback x top-N x rebalance) show positive net excess;
best-cell minus median-cell excess: +6.2%
(a small gap means a plateau, not a lucky spike).

## Regime attribution

- **pre2023**: excess +2.1%, Sharpe 0.517, top contributor NGXASI (+1.03 cum. gross); median capacity NGN 0
- **shock_2023_24**: excess -11.8%, Sharpe 1.655, top contributor NGXOILGAS (+0.49 cum. gross); median capacity NGN 0
- **bull_2025_26**: excess -11.9%, Sharpe 2.74, top contributor NGXOILGAS (+0.54 cum. gross); median capacity NGN 0
...
- regimes: 3 covered (+2)
- significance: corrected p=0.827 (+0)
